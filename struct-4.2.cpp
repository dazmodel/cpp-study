...
void printGroups(student s, int nDisc, int bestMark) {
  cout << "Y studenta #" << s.id << " - " << s.name << " nailu46ie ocenki po takim predmetam: " << endl;
  cout << endl;
...
int main() {
  ...
  cout << "Vvedite nomer studenta v jurnale 4tobu uznat, po kakomy predmety y nego naily46aia ocenka: " << endl;
